...
- Calculate the **meter per pixel scale** at 3.15 m high by measuring a distance in gazebo and then counting the number of pixels corresponding to that length. It was found that at a height of 3.15 metres, 0.905 metres corresponds to 102 pixels.

- Knowing the total witdh of the image in pixels calculate the corresponding witdh in meters using the **meter per pixel scale**. It was found that the visible width at 3.15 m is 2.84 m
...
## Note: 
The videos used code with a slight error in the calculation of GPS coordinates. This has been corrected in the code.
